/*
Deployment script for DatatoolDB2
...
GO
:setvar DatabaseName "DatatoolDB2"
:setvar DefaultFilePrefix "DatatoolDB2"
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'edcdf86f-9365-47cf-99af-f98ec9c7e141')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('edcdf86f-9365-47cf-99af-f98ec9c7e141')
